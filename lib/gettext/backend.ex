defmodule Gettext.Backend do
  ...
  Default handling for particular translations with a missing translation.

  Same as `c:handle_missing_translation/4`, but for particular translations. In this case, `n` is
  the number used for pluralizing the translated string.
  """
  @callback handle_missing_particular_translation(
              Gettext.locale(),
              domain :: String.t(),
              msgctxt :: String.t(),
              msgid :: String.t(),
  ...
  @doc """
  TODO: Improve documentation
  Default handling for particular plural translations with a missing translation.

  Same as `c:handle_missing_translation/4`, but for particular plural translations. In this
  case, `n` is the number used for pluralizing the translated string.
  """
  @callback handle_missing_particular_plural_translation(
              Gettext.locale(),
              domain :: String.t(),
              msgctxt :: String.t(),
              msgid :: String.t(),
