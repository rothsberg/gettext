defmodule Gettext.Compiler do
  ...
  defmacro __before_compile__(env) do
    ...
    quote do
      ...
      def lpgettext(locale, domain, msgctxt, msgid, bindings),
        do: handle_missing_particular_translation(locale, domain, msgctxt, msgid, bindings)
      ...
      def lpngettext(locale, domain, msgctxt, msgid, msgid_plural, n, bindings),
        do:
          handle_missing_particular_plural_translation(
            locale,
            domain,
            msgctxt,
            msgid,
  ...
  defp compile_parallel_po_file(env, path, locales, plural_mod) do
    {locale, domain, singular_fun, particular_fun, plural_fun, particular_plural_fun,
     locale_module_quoted} = compile_po_file(:def, path, env, plural_mod)
    ...
    quoted =
      quote do
        ...
        Kernel.unquote(kind)(unquote(particular_fun)(msgctxt, msgid, bindings)) do
          unquote(env.module).handle_missing_particular_translation(
            unquote(locale),
            unquote(domain),
            msgctxt,
            msgid,
        ...
        Kernel.unquote(kind)(
          ...
          unquote(env.module).handle_missing_particular_plural_translation(
            unquote(locale),
            unquote(domain),
            msgctxt,
            msgid,
